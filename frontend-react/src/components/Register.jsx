      ...
      <div className="w-full max-w-[400px] relative z-10">
        <div className="bg-white rounded-xl shadow-soft border border-slate-200 p-8 overflow-hidden relative">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="group">
              <label htmlFor="password" className="block text-[13px] font-semibold text-gray-700 mb-1.5 transition-colors group-focus-within:text-indigo-600">Password</label>
              <input
                type="password"
                id="password"
                value={password}
